...
migrate((app) => {
  const snapshot = [
    ...
    {
      "createRule": "@request.auth.id = @request.body.user.id && @request.auth.role = \"student\"",
      ...
      "id": "r8y1ijogotx8gfw",
      "indexes": [],
      "listRule": "@request.auth.role = \"teacher\" || @request.auth.id = user.id",
      "name": "choosing_24B",
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.role = \"teacher\"",
    ...
    },
    {
      ...
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.role = \"teacher\" || @request.auth.id = user.id",
      "viewRule": ""
    },
    {
      "authAlert": {
