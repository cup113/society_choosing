...
<template>
  <div
    ...
    <Card
      class="w-full max-w-md border-2 border-amber-300 shadow-xl bg-gradient-to-br from-white to-amber-50 dark:from-stone-800 dark:to-stone-900">
      ...
      <CardContent class="text-center pb-6">
        ...
        <Button @click="goHome" variant="outline"
          class="w-full bg-amber-500 hover:bg-amber-600 text-white border-amber-600 hover:border-amber-700 py-6 text-lg font-bold transition-all duration-300 transform hover:scale-105">
